    ...
    <div id="container-wrapper">
        ...
        <div id="dashboard" class="dashboard-container">
            <div class="dashboard-header sticky-header">
                <div class="content-left  logo-section pull-left">
                    <h1><a href="{{ route('admin.dashboard') }}"><img src="{{ url('admin/assets/images/logo.png') }}" alt=""></a></h1>
                </div>
                        ...
                        <div class="dropdown-menu notification-menu" aria-labelledby="notifyDropdown">
                            ...
                            <ul>
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="{{ url('admin/assets/images/comment4.jpg') }}" alt="">
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="{{ url('admin/assets/images/comment3.jpg') }}" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="{{ url('admin/assets/images/comment2.jpg') }}" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                        ...
                        <div class="dropdown-menu notification-menu">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="{{ url('admin/assets/images/comment5.jpg') }}" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            <div class="dropdown-item profile-sec">
                                <img src="{{ url('admin/assets/images/comment.jpg') }}" alt="">
        ...
        @csrf
            ...
            <div class="copyrights">
               Copyright © {{ date('Y')}} Travele. All rights reserveds.
            </div>
        </div>
        <!-- Dashboard / End -->
    </div>
