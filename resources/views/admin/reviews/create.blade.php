...
<div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Create New Faq</h6>
</div>
<div class="card-body">
@if (count($errors) > 0)
...
<div class="col-xs-12 col-sm-12 col-md-12">
    <div class="form-group">
        ...
        <input name="faq_package[]" class="form-check-input" type="checkbox" value="{{ $package->id }}" id="defaultCheck1" style="z-index: 9999; opacity: unset !important;">
